...
from parse.cobraparser import construct_all_txns_cobra, construct_single_txn4wrrange_cobra, load_logs_cobra
...
def construct_graph_from_log(logs_folder, graphs_folder, analysis_folder,
    ...
    # read logs, filter
    if log_format == "json" or log_format == "edn":
        if log_format == "json":
        ...
        full_history, histories = construct_all_txns_cobra(log_sub_dir)
