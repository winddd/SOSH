...
if __name__ == '__main__':
    ...
    parser.add_argument("--format", type=str, default="json", choices=["edn", "json", "cobra"])
    ...
    print("New run=======================================")
    print(f"Begin verifying {log_full_dir} using ALGO {ALGO}, strong session = {args.strong_session}")
